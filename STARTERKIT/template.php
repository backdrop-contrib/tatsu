 ...
 */
function STARTERKIT_preprocess_maintenance_page(&$variables) {
 ...
 * @see layout.tpl.php
 */
function STARTERKIT_preprocess_layout(&$variables) {
 ...
 * @see header.tpl.php
 */
function STARTERKIT_preprocess_header(&$variables) {
	$logo            = $variables['logo'];
